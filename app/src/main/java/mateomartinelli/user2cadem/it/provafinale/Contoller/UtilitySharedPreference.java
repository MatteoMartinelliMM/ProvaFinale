...
public class UtilitySharedPreference {
    ...
    public static void saveUserReciver(Context context, String sDestinatario) {

        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putString(DESTINATARIO, sDestinatario);
        editor.commit();
    }
    public static String getUserReciver(Context context) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
